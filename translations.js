...
const translations = {
    pt: {
        ...
        'skill-architecture': '🏗️ Arquitetura de Software',
        'skill-ai': '🤖 Inteligência Artificial',
        'skill-automation': '⚡ Automação de Processos',
        'skill-data': '🗄️ Administração de Dados',
    ...
    en: {
        ...
        'skill-architecture': '🏗️ Software Architecture',
        'skill-ai': '🤖 Artificial Intelligence',
        'skill-automation': '⚡ Process Automation',
        'skill-data': '🗄️ Data Administration',
